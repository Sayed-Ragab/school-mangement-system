...
class AddParent extends Component
{
    ...
    public function updated($propertyName)
    {
        $this->validateOnly($propertyName,[
            ...
            'Passport_ID_Father'=>'required|min:10|max:14',
            'Phone_Father'=>'required|max:11|regex:/[0-9]{9}/',
        ...
        try {
            ...
            if(!empty($this->photos)){
              foreach ($this->photos as $photo) {
                  $photo->storeAs($this->National_ID_Father,$photo->getClientOriginalName(),$disk = 'parentAttachment');
...
public function edit($id)
{
    ...
    public function secoundStepSubmit_Edit(){
        $this->updateMode = true;
        $this->currentStep = 3;
    }
    ...
    public function submitForm_edit(){
        ...
        toastr()->warning(__('messages.Update'));

...
Route::middleware('guest')->group(function () {
    ...
    Route::get('forgot-password', [PasswordResetLinkController::class, 'create'])
        ...
        Route::get('login/student',[LoginStudentController::class,'create']);

        Route::post('login/student',[LoginStudentController::class,'store'])->name('login.student');

        Route::GET('Login/teacher',[LoginTeacherController::class,'create'])->name('login');

        Route::POST('Login/teacher',[LoginTeacherController::class,'store'])->name('Login.teacher');    


        Route::get('login/parent',[LoginParentController::class,'create']);
...
Route::Post('logout/student',[LoginStudentController::class,'destroy'])->middleware('auth:student')->name('logout.student');

Route::Post('logout/teacher',[LoginTeacherController::class,'destroy'])->middleware('auth:teacher')->name('logout.teacher');


Route::Post('logout/parent',[LoginParentController::class,'destroy'])->middleware('auth:parent')->name('logout.parent');
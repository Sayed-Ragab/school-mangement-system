...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0" style="font-family:Cairo">     {{__('Fees.Exchange_bonds')}}</h4>
        </div>
        <div class="col-sm-6">
                                ...
                                <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                    ...
                                    @foreach($payments as $payment)
                                        ...
                                        <td>{{$payment->description}}</td>
                                            <td>
                                                <a href="{{route('Pyment_Students.edit',$payment->id)}}" class="btn btn-info btn-sm" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>

...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0" style="font-family:Cairo">  {{__('Dashboard.profile')}}</h4>
        </div>
        <div class="col-sm-6">
            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted mb-4">{{__('parent_trans.parent')}}</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-8">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">
                                        <input type="text" name="Name_ar"
                                               value="{{ $information->getTranslation('Name_Father', 'ar') }}" class="form-control">
                                    </p>
                                </div>
                            </div>
                            <hr>
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">
                                        <input type="text" name="Name_en"
                                               value="{{ $information->getTranslation('Name_Father', 'en') }}" class="form-control">
                                    </p>
                                </div>
                            </div>
                            <hr>

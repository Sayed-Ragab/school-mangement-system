...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> اضافة ترقيه جديده</h4>
        </div>
        <div class="col-sm-6">
        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                @endif
                    ...
                    <h6 style="color: red;font-family: Cairo">{{trans('Students_trans.old_school')}}</h6><br>
                ...
                <form method="post" action="{{ route('Promotion.store') }}">
                    ...
                    <br><h6 style="color: red;font-family: Cairo">{{trans('Students_trans.new_school')}}</h6><br>

...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0" style="font-family:Cairo">  {{trans('Students_trans.Student_details')}}</h4>
        </div>
        <div class="col-sm-6">
                                ...
                                <div class="card card-statistics">
                                    ...
                                    <table class="table center-aligned-table mb-0 table table-hover"
                                        ...
                                        <tbody>
                                            ...
                                            <tr style='text-align:center;vertical-align:middle'>
                                                ...
                                                <td colspan="2">
                                                    ...
                                                    <a class="btn btn-outline-info btn-sm"
                                                       href="{{url('Download_attachment')}}/{{ $Students->name }}/{{$attachment->filename}}"
                                           ...
                                           @include('Dashboard.Students.Deleted_Images')
                                        @endforeach
                                        </tbody>
                                    </table>
                                </div>
